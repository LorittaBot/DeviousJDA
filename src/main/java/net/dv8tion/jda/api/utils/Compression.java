...
public enum Compression
{
     ...
     *
     * <ul>
     *     <li>The default is {@value dev.freya02.discord.zstd.api.ZstdDecompressor#DEFAULT_BUFFER_SIZE}</li>
     *     <li>
     *         A value "recommended" by Zstd is set with {@link dev.freya02.discord.zstd.api.ZstdDecompressor#ZSTD_RECOMMENDED_BUFFER_SIZE ZstdDecompressor.ZSTD_RECOMMENDED_BUFFER_SIZE};
     *         However it is not recommended for normal use cases, see the docs for more details.
     *     </li>
     *     <li>The minimum is {@value dev.freya02.discord.zstd.api.ZstdDecompressor#MIN_BUFFER_SIZE}</li>
     * </ul>
     */
    ZSTD("zstd-stream"),
    ;
